...
public class Clase_AdaptadorArticulos extends RecyclerView.Adapter<Clase_AdaptadorArticulos.ArticulosViewHolder>{

    private Context mCtx;
    private List<Dto> articulosList;


    public Clase_AdaptadorArticulos(Context mCtx, List<Dto> articulosList) {
        this.mCtx = mCtx;
