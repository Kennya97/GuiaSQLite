...
public class ConexionSQLite extends SQLiteOpenHelper {
  ...
  ArrayList<String> listaArticulos;
    //Va a representar la informacion  que se va a mostrar en
    //el combo

    ArrayList<Dto> articulosList; //Entidad que representa a los datos de la tabla en este
    //caso la tabla Articulos
...
Toast.makeText(context, "No hay resultados encontrados para la busqueda especifícada.", Toast.LENGTH_SHORT).show();
}
}catch (Exception e){
            estadoDelete= false;
            Log.e("error.", e.toString());
...
/* INICIO DEL METODO PARA CREAR LISTA DE DATOS DE LA
* BASE DE DATOS EN EL SPINNER*/
